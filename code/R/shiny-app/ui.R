  ...
  sidebar = dashboardSidebar(
    ...
    conditionalPanel(condition = "input.sidebarmenu == 'plots_ppp'",
      awesomeCheckboxGroup(
        ...
        label = "Parameter", 
        choices = c("logK","r","sigmao_add","sigmap","shape","qeff","rho","sigma_qdev","x0","sigmaf","nu_catch"),
        selected = c("logK", "r")
      ),
      switchInput(
        inputId = "ppp.raw",  
    ...
    conditionalPanel(condition="input.sidebarmenu == 'plots_hmc'",
     awesomeCheckboxGroup(
        ...
        label = "Parameter", 
        choices = c("logK","r","sigmao_add","sigmap","shape","qeff","rho","sigma_qdev","x0","sigmaf","nu_catch","lp__"),
        selected = c("logK", "r")
      ),
      switchInput(
        inputId = "hmc.raw",  
