...
Parameter combinations were filtered through sequential criteria based on population viability and fishery realism:
...
## One-off sensitivities {#sec-one-off}
...
Table: Prior distributions for effort-based Bayesian surplus production model leading parameters. {#tbl-priors}
