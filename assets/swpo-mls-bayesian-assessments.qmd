...
The estimated depletion^[Note that depletion for the surplus producation model is a *static* depletion defined relative to total unfished numbers $D_t=P_t/P_0$; where $P_t$ is the total population level in numbers at time $t$, and $P_0 = K$ the unfished population numbers or carrying capacity. This is different from the *dynamic* depletion of spawning biomass $SB_t/SB_{t,F=0}$ that is typically reported from integrated age-structured models such as MULTIFAN-CL or Stock Synthesis [@methot_jr_stock_2013].] time series from the model ensemble shows a decline from the assumed unfished state in 1952 to minimum levels around the mid-2010s (@fig-ens-timeseries). The decline was most pronounced during the 1950s and 1960s, followed by relatively stable depletion levels from the 1970s through the early 2000s which fluctuated round $\sim 0.4-0.6$. The stock has been estimated to be recovering from the mid-2010s. Credible intervals around depletion estimates are relatively wide, reflecting inherent uncertainty in the population scale.

The estimated population time series mirrors these depletion patterns. It is important to note that while the uncertainty in absolute population size is substantial, as reflected in wide credible intervals, this uncertainty is asymmetric. The model is fairly confident that the model can not be much smaller than what it currently is estimated to be due to the hard constraint of at least being large enough to support the 70 year time-series of catches. As seen in the one-off sensitivites (@sec-res-sens-scaling & @sec-res-sens-rmax), uncertainty to the high-side is driven in part by the prior assumptions for $\log(K)$, $q_{eff}$, and $R_{Max}$, as well as by model structrual choices with regards to treatment of catch uncertainty (@sec-res-sens-catch-obs) and structure of fishing mortality (@sec-res-sens-effort). 

Process error estimates showed consistent temporal variability across ensemble models, with the largest deviations occurring in the 1970s and 1980s. This indicates that removals alone could not explain the observed changes in the standardized indices in these time periods, suggesting additional factors influencing population dynamics during these periods or insufficient observation error. 

[Fishing mortality estimates display high variability throughout the time series, with substantial uncertainty reflected in wide credible intervals. The F time series shows episodic peaks during the 1970s and 1980s, corresponding to periods of intensive fishing pressure, followed by more variable but generally declining trends in recent decades. This pattern is consistent with the observed recovery in population depletion during the same period.

Catchability deviations demonstrate substantial temporal variation, particularly during the early period of the fishery. The estimates show generally declining trends from elevated levels in the 1950s and 1960s toward more stable values in recent decades. This temporal pattern likely reflects changes in fishing technology, fleet behavior, and spatial distribution of fishing effort over the model period.
Nominal CPUE estimates from the model ensemble track the general declining trend observed in the standardized index, showing elevated values during the early unfished period followed by substantial declines through the 1980s and 1990s. Recent nominal CPUE estimates show stabilization at lower levels consistent with the moderate depletion levels estimated for the contemporary period, though with continued high uncertainty around point estimates.]
