...
| Model | Max $\hat{R}$ | Min ESS | Divergent | Tree Depth | BFMI Issues | Index RMSE |
|-------|---------------|---------|-----------|------------|-------------|-------------|
| 0001-2024cpueExPrior | `r round(baseline$max_rhat, 3)` | `r round(baseline$min_neff, 0)` | `r baseline$divergent` | `r baseline$treedepth` | `r baseline$low_bfmi` | `r round(baseline$median_rmse, 3)` |
| 0002-2024cpueDepPrior | `r round(constrained$max_rhat, 3)` | `r round(constrained$min_neff, 0)` | `r constrained$divergent` | `r constrained$treedepth` | `r constrained$low_bfmi` | `r round(constrained$median_rmse, 3)` |
