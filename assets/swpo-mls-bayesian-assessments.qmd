...
repnumber: WCPFC-SC21-2025/SA-WP-07 rev1
format:
  pdf:
    pdf-engine: pdflatex
    template-partials:
...
**Rev 1:** In the initial version, the *median* values listed in @tbl-stock-status actually reported the *mean* from the posterior distribution. In the current revision this has been fixed, and the median values are reported.
