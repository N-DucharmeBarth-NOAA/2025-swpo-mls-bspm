...
::: {.fragment .fade-out fragment-index=2}
::: {.fragment .fade-in fragment-index=1}
![](../plots/pushforward/bspm_estqsimple_softdep_mvprior_x0_newlogK/pairs.leading.updated_prior.png){.absolute left=55% top=25% height=50% width=auto style="box-shadow: 0 0 2rem 0 rgba(0, 0, 0, .5); border-radius: 5px;"}
:::
:::
...
::: {.fragment .fade-out fragment-index=2}
::: {.fragment .fade-in fragment-index=1}
::: {.absolute top=40% left=50% width=25%}
::: {.callout-note}
## Retrospectives
...
::: {.fragment .fade-out fragment-index=4}
::: {.fragment .fade-in fragment-index=3}
::: {.absolute top=40% left=70% width=25%}
::: {.callout-note}
## Hindcast
• Models refit excluding terminal years of index
...
::: {.callout-note}
## Posterior update
• If posterior (solid line) differs from prior (dotted line) distribution, data inform estimates
...
• Population scale sensitive to catch magnitude but relative status metrics remain consistent
:::
:::
:::
:::
...
::: {.fragment .fade-out fragment-index=1}
::: {.absolute top=60% left=50% width=50%}
::: {.callout-note}
## Kobe plot
...
::: {.absolute bottom=0 left=0 style="font-size:0.65em; color: gray;"}
**Conclusion:** Continued recovery expected under recent catch levels with very low risk of overfishing.
:::
...
- High uncertainty in key biological processes
:::

::: {.fragment .fade-in fragment-index=4}
**Environmental factors:**

- Climate variability not explicitly modeled
- Process error spikes suggests unmodeled drivers
:::
...
- Move toward fully integrated age-structured models
:::
...
All data inputs, model code, key model outputs, figures and report files are publicly available on GitHub:

<https://github.com/N-DucharmeBarth-NOAA/2025-swpo-mls-bspm>
