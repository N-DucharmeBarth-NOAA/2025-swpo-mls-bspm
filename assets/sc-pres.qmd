...
::: {.fragment .fade-in fragment-index=2}
![](../plots/density_plots_fisheries_params.png){.absolute left=5% top=15% height=70% width=auto style="box-shadow: 0 0 2rem 0 rgba(0, 0, 0, .5); border-radius: 5px;"}
:::
...
::: {.fragment .fade-in fragment-index=2}
::: {.absolute top=35% left=40% width=60%}
::: {.callout-note}
## Marginal posterior distributions
• [$D/D_{MSY}$]{.blue}: Majority of distribution (`r round(ens_probs[name == "recent_D_Dmsy", prop_meeting_condition] * 100, 0)`%) below $D/D_{MSY}$

• [$F/F_{MSY}$]{.blue}: Minority of distribution (`r round(ens_probs[name == "recent_F_Fmsy", prop_meeting_condition] * 100, 0)`%) above $F/F_{MSY}$

• [Population scale]{.blue}: Data supports a small recent population with large, asymmetric uncertainty to the high side
:::
...
::: {.fragment .fade-out fragment-index=2}
::: {.absolute bottom=50 left=0 style="font-size:0.65em;"}
...
## Conclusions {.narrow-left-bg-image .smaller}
